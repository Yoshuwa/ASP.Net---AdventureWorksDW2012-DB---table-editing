...
<%@ Page Title="dbo_FactSalesQuota" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="frmdbo_FactSalesQuota.aspx.cs" Inherits="AdventureWorksDW2012.frmdbo_FactSalesQuota" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <%-------------------------------------%>
            <div style="text-align: center;">
                ...
                <%-----
                    If GridView (grddbo_FactSalesQuota) width is bigger than web-page (or screen) width (for Mobile and Tablet)...
        ...
        <%--<div style="width: 100%;">
                ...
                <%-------------------------------------%>
                    <asp:GridView id="grddbo_FactSalesQuota" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="SalesQuotaKey" 
                        OnRowCancelingEdit="grddbo_FactSalesQuota_RowCancelingEdit" OnRowDataBound="grddbo_FactSalesQuota_RowDataBound" OnRowEditing="grddbo_FactSalesQuota_RowEditing"
                        OnPageIndexChanging="grddbo_FactSalesQuota_PageIndexChanging" OnSorting="grddbo_FactSalesQuota_Sorting" 
                        OnRowUpdating="grddbo_FactSalesQuota_RowUpdating" OnRowCommand="grddbo_FactSalesQuota_RowCommand" OnRowDeleting="grddbo_FactSalesQuota_RowDeleting" ShowFooter="True" Font-Size="Medium" >
                        <Columns>
                            <asp:TemplateField HeaderText="Sales Quota Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="SalesQuotaKey">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSalesQuotaKey" width="100px" runat="server" CssClass="input" Text='<%# Eval("SalesQuotaKey") %>' style="text-align: right;" BackColor="BlanchedAlmond"></asp:TextBox>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtNewSalesQuotaKey" width="100px" runat="server" CssClass="input" style="text-align: right;" BackColor="LightYellow"></asp:TextBox>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblSalesQuotaKey" width="100px" runat="server" Text='<%# Eval("SalesQuotaKey") %>' style="text-align: right;"></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Sales Amount Quota" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="SalesAmountQuota">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSalesAmountQuota" width="100px" runat="server" CssClass="input" Text='<%# Eval("SalesAmountQuota") %>' style="text-align: right;" BackColor="BlanchedAlmond"></asp:TextBox>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtNewSalesAmountQuota" width="100px" runat="server" CssClass="input" style="text-align: right;" BackColor="LightYellow"></asp:TextBox>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblSalesAmountQuota" width="100px" runat="server" Text='<%# Eval("SalesAmountQuota", "{0:C}") %>' style="text-align: right;"></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <input id="htmlHiddenSortExpression" type="hidden" value="SalesQuotaKey" name="htmlHiddenSortExpression" runat="server" />
                </div>
            </div>
        </section>
</asp:Content>
