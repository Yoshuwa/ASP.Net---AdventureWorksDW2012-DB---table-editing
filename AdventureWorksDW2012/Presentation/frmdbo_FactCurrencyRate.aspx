...
<%@ Page Title="dbo_FactCurrencyRate" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="frmdbo_FactCurrencyRate.aspx.cs" Inherits="AdventureWorksDW2012.frmdbo_FactCurrencyRate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <%-------------------------------------%>
            <div style="text-align: center;">
                ...
                <%-----
                    If GridView (grddbo_FactCurrencyRate) width is bigger than web-page (or screen) width (for Mobile and Tablet)...
        ...
        <%--<div style="width: 100%;">
                ...
                <%-------------------------------------%>
                    <asp:GridView id="grddbo_FactCurrencyRate" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="CurrencyKey" 
                        OnRowCancelingEdit="grddbo_FactCurrencyRate_RowCancelingEdit" OnRowDataBound="grddbo_FactCurrencyRate_RowDataBound" OnRowEditing="grddbo_FactCurrencyRate_RowEditing"
                        OnPageIndexChanging="grddbo_FactCurrencyRate_PageIndexChanging" OnSorting="grddbo_FactCurrencyRate_Sorting" 
                        OnRowUpdating="grddbo_FactCurrencyRate_RowUpdating" OnRowCommand="grddbo_FactCurrencyRate_RowCommand" OnRowDeleting="grddbo_FactCurrencyRate_RowDeleting" ShowFooter="True" Font-Size="Medium" >
                        <Columns>
                    ...
                    <input id="htmlHiddenSortExpression" type="hidden" value="CurrencyKey" name="htmlHiddenSortExpression" runat="server" />
                </div>
            </div>
        </section>
</asp:Content>
