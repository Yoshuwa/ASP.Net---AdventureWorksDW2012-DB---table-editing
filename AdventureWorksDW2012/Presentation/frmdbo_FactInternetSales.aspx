...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <%--<div style="width: 100%;">
                ...
                <%-------------------------------------%>
                    <asp:GridView id="grddbo_FactInternetSales" runat="server" AllowPaging="True" PageSize="5" AutoGenerateColumns="False" AllowSorting="True" DataKeyNames="SalesOrderNumber" 
                        OnRowCancelingEdit="grddbo_FactInternetSales_RowCancelingEdit" OnRowDataBound="grddbo_FactInternetSales_RowDataBound" OnRowEditing="grddbo_FactInternetSales_RowEditing"
                        OnPageIndexChanging="grddbo_FactInternetSales_PageIndexChanging" OnSorting="grddbo_FactInternetSales_Sorting" 
                        OnRowUpdating="grddbo_FactInternetSales_RowUpdating" OnRowCommand="grddbo_FactInternetSales_RowCommand" OnRowDeleting="grddbo_FactInternetSales_RowDeleting" ShowFooter="True" Font-Size="Medium" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Product Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="EnglishProductName">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtProductKey" width="100px" runat="server" CssClass="input" DataTextField="EnglishProductName" DataValueField="ProductKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewProductKey" width="100px" runat="server" CssClass="input" DataTextField="EnglishProductName" DataValueField="ProductKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblProductKey" width="100px" runat="server" Text='<%# Eval("EnglishProductName") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Order Date Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="FullDateAlternateKey">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtOrderDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewOrderDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblOrderDateKey" width="100px" runat="server" Text='<%# Eval("FullDateAlternateKey") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Due Date Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="FullDateAlternateKey">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtDueDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewDueDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblDueDateKey" width="100px" runat="server" Text='<%# Eval("FullDateAlternateKey") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Ship Date Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="FullDateAlternateKey">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtShipDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewShipDateKey" width="100px" runat="server" CssClass="input" DataTextField="FullDateAlternateKey" DataValueField="DateKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblShipDateKey" width="100px" runat="server" Text='<%# Eval("FullDateAlternateKey") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Customer Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="FirstName">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtCustomerKey" width="100px" runat="server" CssClass="input" DataTextField="FirstName" DataValueField="CustomerKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewCustomerKey" width="100px" runat="server" CssClass="input" DataTextField="FirstName" DataValueField="CustomerKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblCustomerKey" width="100px" runat="server" Text='<%# Eval("FirstName") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Promotion Key" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" FooterStyle-HorizontalAlign="Left" SortExpression="EnglishPromotionName">
                                <EditItemTemplate>
                                    <asp:DropDownList ID="txtPromotionKey" width="100px" runat="server" CssClass="input" DataTextField="EnglishPromotionName" DataValueField="PromotionKey" BackColor="BlanchedAlmond"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="txtNewPromotionKey" width="100px" runat="server" CssClass="input" DataTextField="EnglishPromotionName" DataValueField="PromotionKey" BackColor="LightYellow"></asp:DropDownList>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </FooterTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblPromotionKey" width="100px" runat="server" Text='<%# Eval("EnglishPromotionName") %>'></asp:Label>
                                    <asp:Label runat="server" Width="5px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
